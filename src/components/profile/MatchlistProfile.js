...
export function MatchlistProfile({
  name,
  age,
  city,
  location,
  ...
  // // console.log("sexIdentity", sexIdentity); // เปลี่ยนจาก gender เป็น sexIdentity
  // // console.log("age", age);
  // // console.log("aboutMe", aboutMe); // เปลี่ยนจาก about_me เป็น aboutMe
  // // console.log("city", city);
  // console.log("hobby", hobby); // เปลี่ยนจาก hobbies เป็น hobby
  // // console.log("image", image); // เปลี่ยนจาก image_profile เป็น image
  // // console.log("location", location);
  // // console.log("meetingInterest", meetingInterest); // เปลี่ยนจาก meeting_interest เป็น meetingInterest
  // // console.log("racialPref", racialPref); // เปลี่ยนจาก racial_identity เป็น racialPref
  // // console.log("racialPreference", racialPreference); // เปลี่ยนจาก racial_preference เป็น racialPreference
  // // console.log("sexualPref", sexualPref); // เปลี่ยนจาก sexual_preference เป็น sexualPref
        ...
        <div className="lg:px-14 lg:pb-12">
          <div className="lg:flex lg:flex-row lg:gap-7">
            ...
            <div className="information flex flex-col gap-6 px-4 py-6 lg:w-full lg:gap-10 lg:pb-0 lg:pl-[60px] lg:pt-6">
              ...
              {/* about-me */}
              <div className="about-me flex max-w-[26rem] flex-col gap-3 lg:gap-4">
                <h4 className="text-2xl font-bold text-fourth-900">About me</h4>
                <p className="overflow-hidden text-ellipsis text-base font-normal text-fourth-900">
                  {aboutMe}
                </p>
              </div>
              ...
              <div className="hobbies-interests flex flex-col gap-3 lg:gap-6">
                ...
                <div className="hobby-list flex flex-wrap pb-10 lg:pb-0 items-center gap-3">
